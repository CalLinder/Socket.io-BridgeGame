...
AFRAME.registerComponent('custom-player-physics', {
    ...
    tick: function(time, timeDelta) {      
        ...
        if (CONTEXT_AF.rigObject.object3D.position.x < -9.5) {
            CONTEXT_AF.rigObject.object3D.position.set(-9.5, CONTEXT_AF.rigObject.object3D.position.y, CONTEXT_AF.rigObject.object3D.position.z);
        }
        // CHECK PLAYER +X POSITION
        if (CONTEXT_AF.rigObject.object3D.position.x > 9.5) {
            CONTEXT_AF.rigObject.object3D.position.set(9.5, CONTEXT_AF.rigObject.object3D.position.y, CONTEXT_AF.rigObject.object3D.position.z);
